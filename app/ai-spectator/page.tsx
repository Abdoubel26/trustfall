                    ...
                    <div>
                      {outcome === "dopamine" && (
                        <div>
                          ...
                          <p className="text-xs hidden lg:flex text-amber-300/70 mt-1 tracking-wide">
                      ...
                      {outcome === "shame" && (
                        <div>
                          ...
                          <p className="text-xs hidden lg:flex text-red-400/70 mt-1 tracking-wide">
                            {getModelName(betaModel)} just went nuclear.
                          </p>
                        </div>
                      )}
                      {outcome === "hooray" && (
                        <div>
                          ...
                          <p className="text-xs hidden lg:flex text-emerald-400/70 mt-1 tracking-wide">
                      ...
                      {outcome === "ruin" && (
                        <div>
                          ...
                          <p className="text-xs hidden lg:flex text-zinc-500 mt-1 tracking-wide">
